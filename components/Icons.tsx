...
export const CurrencyYenIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-6h6m-6 3h6m-6-6h6M3 12a9 9 0 1 1 18 0 9 9 0 0 1-18 0Z" />
  </svg>
);

export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a12.022 12.022 0 0 0-5.84 0m5.84 0a11.953 11.953 0 0 1 2.18-5.84m-8.02 5.84a12.083 12.083 0 0 1-2.18-5.84m12.38-3.95L19.5 6.07m-5.84 12.38L9 18.14m-3.95-12.38L6.07 9m12.38-3.95-1.42 1.42M9 6.07l-1.42-1.42m12.38 3.95-1.42-1.42M6.07 9l-1.42 1.42" />
  </svg>
);
